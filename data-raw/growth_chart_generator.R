# Generate growth charts with arbitrary percentile lines, and plot patient data points
# - use lmsdata available ages rather than interpolating

# library(peditools) # for lmsdata (not exported) and z_lms_to_x
# library(tidyr)     # for gather()
library(ggplot2)

load("/Users/jchou/Dropbox (Partners HealthCare)/R/peditools/R/sysdata.rda") # needs lmsdata from sysdata.rda
